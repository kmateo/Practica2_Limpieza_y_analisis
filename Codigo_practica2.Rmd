...
******
## Importancia de ser portero
******

```{r,eval=TRUE,echo=TRUE,message=FALSE}
oddsRatio <-exp(cbind(OR = coef(modelo_logistico2), confint(modelo_logistico2)))
oddsRatio
```
...
```{r,eval=TRUE,echo=TRUE,message=FALSE}
oddsRatio <-exp(cbind(OR = coef(modelo_logistico3), confint(modelo_logistico3)))
oddsRatio
```
